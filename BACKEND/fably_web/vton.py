...
def tryOn(garment_url, person_url, webhook):
    ...
    try:
        response = requests.post(
            ...
            headers={"Authorization": f"Bearer {config.FASHN_API_KEY}", "Content-Type": "application/json"},
            json={
...
if __name__ == '__main__':
    ...
    garment_url = "https://res.cloudinary.com/dcmelcukm/image/upload/v1742184821/blue_tshirt_lz35lx.jpg"
